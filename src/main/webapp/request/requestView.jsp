...
<body>
	...
	<%-- 
		...
		String getParameter(String param) : param에 해당하는 파라미터 값을 조회한다. 파라미터맵에서 첫번째 값을 반환
	...
	--%>
	<form id="form" action="${pageContext.request.contextPath }/request/requestResponse.jsp" method=''>
	...
	GET POST 두가지를 선택할 수 있는 라디오 버튼을 만들어서 FROM 전송시 사용자가 GET, POST방식을 지정할 수 있도록 하기 <br>
	
	GET <input class="method" type="radio" name="method" value="GET">
	POST <input class="method" type="radio" name="method" value="POST">
